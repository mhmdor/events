                ...
                <form method="POST" class="data" action="{{ route('createSarname') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="title" type="text" placeholder="السيد"
                                        class="p-3 @error('title') is-invalid @enderror" name="title"
                            ...
                            {{-- <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="Sarname_id" id="" class="p-3">
                                        <option value="" disabled selected>Choose</option>
                                        @foreach ($Categries as $Sarname)
                                        <option value="{{$Sarname->id}}">{{$Sarname->name}}</option>  
                                        @endforeach
                    ...
                    <div class="bottom d-flex align-items-center justify-content-between">
                        ...
                        <div class="buttons d-flex align-items-center gap-4">
                            <a href="{{ route('getSarname') }}">Cancel</a>
