      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="add-client add-company pt-4 px-3 mb-5">
                ...
                <form method="POST" class="data" action="{{ route('updateSarname') }}">
                    @csrf

                    <input name="id" value="{{ $Sarname->id }}" hidden>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    <label>Sarname name</label>

                                    <input id="title" type="text"
                                        class="p-3 @error('title') is-invalid @enderror" name="title"
                                        value="{{ $Sarname->title }}" required autocomplete="title" autofocus>
