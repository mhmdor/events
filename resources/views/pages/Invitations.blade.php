...
<body>
      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="latest pt-4 px-3 d-flex gap-3 mb-5">
                <div class="clients">
                    <div class="head d-flex align-items-center justify-content-end mb-4">
                        <div class="right">
                            <div class="addClient">
                                <a href="{{ route('createInvitation') }}" class="d-flex align-items-center gap-2">
                        ...
                        <table class="bg-white">
                            ...
                            @foreach ($Invitations as $Invitation)
                                <tbody>
                                    ...
                                    <td>{{ $Invitation->Sarname->title }} </td>
                                    <td>{{ $Invitation->nickname->title }} </td>
                                    <td>{{ $Invitation->Category->title }} </td>
                                    ...
                                    <td class="d-flex align-items-center justify-content-center gap-sm-3 gap-2">
                                        ...
                                        <a href="{{ route('editInvitation', $Invitation->id) }}">
                                            <li>
                                        ...
                                        <form id="myform" method="POST" action="{{ route('deleteInvitation') }}">
                                            @csrf
                                            <input hidden value="{{ $Invitation->id }}" id="" name="id"
                                                type="text">
                                            <a onclick="document.getElementById('myform').submit()"><svg
    ...
    <!-- Bootstrap -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.0.1/js/bootstrap.min.js" crossorigin="anonymous">
    </script>
