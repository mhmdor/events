      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="add-client add-company pt-4 px-3 mb-5">
                ...
                <form method="POST" enctype="multipart/form-data" class="data" action="{{ route('createInvitation') }}">
                    @csrf
                        ...
                        <div class="mb-4">
                            ...
                            {{-- <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="Invitation_id" id="" class="p-3">
                                        <option value="" disabled selected>Choose</option>
                                        @foreach ($Categries as $Invitation)
