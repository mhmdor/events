            ...
            <div class="latest pt-4 px-3 d-flex gap-3 mb-5">
                <div class="clients">
                    <div class="head d-flex align-items-center justify-content-end mb-4">
                        <div class="right">
                            <div class="addClient">
                                <a href="{{ route('createSarname') }}" class="d-flex align-items-center gap-2">
                    ...
                    <div class="scroll">
                        <table class="bg-white">
                            ...
                            @foreach ($Sarnames as $Sarname)
                                <tbody>
                                    <td>{{ $Sarname->id }}</td>
                                    <td>{{ $Sarname->title }} </td>

                                    <td>{{ $Sarname->created_at }}</td>

                                    <td class="d-flex align-items-center justify-content-center gap-sm-3 gap-2">

                                        <a href="{{ route('editSarname', $Sarname->id) }}">
                                            <li>
                                        ...
                                        <form id="myform" method="POST" action="{{ route('deleteSarname') }}">
                                            @csrf
                                            <input hidden value="{{ +$Sarname->id }}" id="" name="id"
                                                type="text">
