            ...
            <div class="latest pt-4 px-3 d-flex gap-3 mb-5">
                <div class="clients">
                    <div class="head d-flex align-items-center justify-content-end mb-4">
                        <div class="right">
                            <div class="addClient">
                                <a href="{{ route('createEvent') }}" class="d-flex align-items-center gap-2">
                        ...
                        <table class="bg-white">
                            ...
                            @foreach ($Events as $Event)
                                <tbody>
                                    ...
                                    <td><img style="height: 40px" src="{{asset('assets/events/'.$Event->photo)}}" alt=""></td>
                                    ...
                                    <td class="d-flex align-items-center justify-content-center gap-sm-3 gap-2">
                                        ...
                                        <form id="myform" method="POST" action="{{ route('deleteEvent') }}">
                                            @csrf
                                            <input hidden value="{{ +$Event->id }}" id="" name="id"
                                                type="text">
