            ...
            <div class="latest pt-4 px-3 d-flex gap-3 mb-5">
                <div class="clients">
                    <div class="head d-flex align-items-center justify-content-end mb-4">
                        <div class="right">
                            <div class="addClient">
                                <a href="{{ route('createCategory') }}" class="d-flex align-items-center gap-2">
                            ...
                            @foreach ($Categorys as $Category)
                                <tbody>
                                    ...
                                    <td class="d-flex align-items-center justify-content-center gap-sm-3 gap-2">
                                        ...
                                        <form id="myform" method="POST" action="{{ route('deleteCategory') }}">
                                            @csrf
                                            <input hidden value="{{ +$Category->id }}" id="" name="id"
                                                type="text">
