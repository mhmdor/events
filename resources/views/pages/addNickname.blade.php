                ...
                <form method="POST" class="data" action="{{ route('createNickname') }}">
                        ...
                        <div class="mb-4">
                            ...
                            {{-- <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="Nickname_id" id="" class="p-3">
                                        <option value="" disabled selected>Choose</option>
                                        @foreach ($Categries as $Nickname)
                    ...
                    <div class="bottom d-flex align-items-center justify-content-between">
                        ...
                        <div class="buttons d-flex align-items-center gap-4">
                            <a href="{{ route('getNickname') }}">Cancel</a>
