      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="add-client add-company pt-4 px-3 mb-5">
                ...
                <form method="POST" class="data" action="{{ route('createPlace') }}">
                    @csrf
                    ...
                    <div class="top bg-white p-4 mb-5">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    <label>Place plan</label>

                                    <input id="plan" type="text" 
                                        class="p-3 @error('plan') is-invalid @enderror" name="plan"
                                        value="{{ old('plan') }}" required autocomplete="plan" autofocus>
                            ...
                            {{-- <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="Place_id" id="" class="p-3">
                                        <option value="" disabled selected>Choose</option>
                                        @foreach ($Categries as $Place)
