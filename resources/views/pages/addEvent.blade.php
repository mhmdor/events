      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="add-client add-company pt-4 px-3 mb-5">
                ...
                <form method="POST" enctype="multipart/form-data" class="data" action="{{ route('createEvent') }}">
                    @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="photo" type="file" 
                                        class="p-3 @error('photo') is-invalid @enderror" name="photo"
                            ...
                            {{-- <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="Event_id" id="" class="p-3">
                                        <option value="" disabled selected>Choose</option>
                                        @foreach ($Categries as $Event)
                                        <option value="{{$Event->id}}">{{$Event->name}}</option>  
                                        @endforeach
