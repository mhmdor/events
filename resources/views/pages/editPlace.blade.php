      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="add-client add-company pt-4 px-3 mb-5">
                ...
                <form method="POST" class="data" action="{{ route('updatePlace') }}">
                    @csrf

                    <input name="id" value="{{ $Place->id }}" hidden>
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="name" type="text" 
                                        ...
                                        value="{{ $Place->name }}" required autocomplete="name" autofocus>
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="plan" type="text" 
                                        class="p-3 @error('plan') is-invalid @enderror" name="plan"
                                        value="{{ $Place->plan }}" required autocomplete="plan" autofocus>
                    ...
                    <div class="bottom d-flex align-items-center justify-content-between">
                        ...
                        <div class="buttons d-flex align-items-center gap-4">
                            <a href="{{ route('getPlace') }}">Cancel</a>
