      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="add-client add-company pt-4 px-3 mb-5">
                ...
                <form method="POST" class="data" action="{{ route('updateEvent') }}">
                    @csrf
                    ...
                    <div class="top bg-white p-4 mb-5">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="name" type="text" 
                                        ...
                                        value="{{ $Event->title }}" required autocomplete="name" autofocus>
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="time" type="time" 
                                        class="p-3 @error('time') is-invalid @enderror" name="time"
                                        value="{{ $Event->time }}" required autocomplete="time" autofocus>
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="date" type="date" 
                                        class="p-3 @error('date') is-invalid @enderror" name="date"
                                        value="{{ $Event->date }}" required autocomplete="date" autofocus>
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input id="description" type="text" 
                                        class="p-3 @error('description') is-invalid @enderror" name="description"
                                        value="{{ $Event->description }}" required autocomplete="description" autofocus>
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    <label>Place</label>
                                    <select name="place_id" id="" class="p-3" required>
                                       
                                        <option value="{{$Event->place->id}}">{{$Event->place->name}}</option>  
                                        @foreach ($Categries as $Event)
                    ...
                    <div class="bottom d-flex align-items-center justify-content-between">
                        ...
                        <div class="buttons d-flex align-items-center gap-4">
                            <a href="{{ route('getEvent') }}">Cancel</a>
