...
<body>
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                        ...
                        borderWidth: 1,
                        borderColor: "#F2921F",
                        backgroundColor: "#F2921F"
                    },
                    {
                        label: 'Complete',
                        data: [40, 10, 30, 50, 0, 10],
                        borderWidth: 1,
                        borderColor: "#2C3E83",
                        backgroundColor: "#2C3E83"
                    },
                    {
                        label: 'Done',
                        data: [70, 30, 50, 60, 20, 30],
                        borderWidth: 1,
                        borderColor: "#10E974",
                        backgroundColor: "#10E974"
                    },
                    {
                        label: 'Reject',
                        data: [100, 10, 30, 70, 0, 30],
                        borderWidth: 1,
                        borderColor: "#EB1010",
        ...
        new Chart(ctx1, {
            type: 'doughnut',
            data: {
                labels: ['Pending', 'Complete', 'Done', 'Reject'],
                datasets: [{
                    label: '# of Votes',
                    data: [25, 25, 25, 25],
                    backgroundColor: ["#F2921F", "#2C3E83", "#10E974", "#EB1010"]
                }]
            },
            options: {
                scales: {
        ...
        new Chart(ctx2, {
            type: 'bar',
            data: {
                labels: ["Social Media", "Refer", "Ads", "Ads", "Ads"],
                datasets: [{
